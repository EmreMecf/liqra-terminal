...
class PrinterService {
  ...
  Future<void> printReceipt({
    ...
    pdf.addPage(
      pw.Page(
        pageFormat: PdfPageFormat(_pageWidth, PdfPageFormat.a4.height,
          ...
          children: [
            ...
            ...items.map((item) => pw.Padding(
              ...
              child: pw.Row(children: [
                pw.Expanded(flex: 5,
                    child: pw.Text(item.product.name, style: const pw.TextStyle(fontSize: 9))),
            ...
            pw.SizedBox(height: 4),
            pw.Center(child: pw.Text(_paymentLabel(paymentMethod, customerName),
                style: const pw.TextStyle(fontSize: 9))),
            pw.SizedBox(height: 12),
            pw.Center(child: pw.Text('Teşekkürler!', style: const pw.TextStyle(fontSize: 10))),
  ...
  String _paymentLabel(PaymentMethod pm, String? customerName) {
    switch (pm) {
      case PaymentMethod.cash:   return 'Ödeme: Nakit';
      case PaymentMethod.card:   return 'Ödeme: Kredi Kartı';
      case PaymentMethod.credit: return 'Veresiye: ${customerName ?? 'Müşteri'}';
    }
  }
